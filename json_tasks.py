...
# %
# 75% или более
# Программа должна создать файл data_0.csv с двумя столбцами — name (имя) и phone (номер), и записать в него данные выбранных студентов, расположив их в лексикографическом порядке имён. В качестве разделителя в файле data_0.csv должна быть использована запятая.
#
# Примечание 1. Гарантируется, что все студенты имеют различные имена.
#
# Примечание 2. Начальная часть файла data_0.csv выглядит так:
#
# name,phone
# Cary,(580) 476-8517
